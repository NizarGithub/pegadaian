...
insert  into `item_details`(`item_detail_id`,`item_id`,`item_merk`,`item_tipe`,`item_berat`,`item_p`,`item_l`,`item_t`,`item_penerbit`,`item_desc`) values (28,1,'Nokia','Lumia',0,0,0,0,'','                                                                                                                                                                                              '),(37,13,'','',0,0,0,0,'',''),(38,2,'Samsung','Galaxy S 3',0,0,0,0,'','                                                                                                                                                                                                                                    '),(47,28,'Honda','Bebek Super',0,0,0,0,'','                                                                            '),(48,29,'Maspion','CEILING EXHAUST FAN 10â€³ CEF-2510',0,0,0,0,'','                                                                            '),(49,31,'POLYTRON','[PRN 160B]',0,0,0,0,'','                                      '),(52,39,'Honda','',0,0,0,0,'','                                      '),(53,41,'SAMSUNG','J5 PRIME',0,0,0,0,'','J5 PRIME FINGGER PRINT');
...
insert  into `item_keterangan_details`(`item_keterangan_details_id`,`purchase_id`,`item_id`,`kategori_id`,`kategori_keterangan_id`,`keterangan_details`,`supplier`,`status`) values (1,0,0,0,0,'',0,0),(2,2,1,6,4,'q1',1,0),(3,2,1,6,5,'q2',1,0),(4,2,1,6,13,'q3',1,0),(5,4,1,6,4,'12233686',1,1),(6,4,1,6,5,'546756228',1,0),(7,4,1,6,13,'6352357648',1,0),(8,5,41,6,4,'6289992727',7,0),(9,5,41,6,5,'626255',7,0),(10,5,41,6,13,'2800',7,0);
...
insert  into `item_stocks`(`item_stock_id`,`item_id`,`item_type_id`,`item_stock_qty`,`branch_id`) values (1,1,0,3,3),(2,39,0,1,3),(3,41,0,0,3);
...
insert  into `kredit`(`kredit_id`,`transaction_id`,`kredit_code`,`user_id`,`member_id`,`item_id`,`jenis_item`,`administrasi`,`harga_item`,`uang_muka_barang`,`payment_method_id`,`bank_id_angsuran`,`bank_account_angsuran`,`bank_id_to_angsuran`,`bank_account_to_angsuran`,`nilai_pembiayaan`,`lama_angsuran`,`periode`,`angsuran_per_bulan`,`pembayaran_per_tanggal_1`,`pembayaran_per_tanggal_2`,`kredit_date`,`kredit_total`,`lunas`) values (1,4,'K_148937339',1,34,1,6,0,1400000,300000,1,0,'',0,'',1100000,7,3,157200,'01 ',' 13','2017-03-13 03:49:08',0,1),(2,5,'K_148937532',1,35,41,6,10000,2800000,700000,1,0,'',0,'',2100000,6,3,350000,'14 ',' 24','2017-03-13 04:19:22',0,1),(3,6,'K_148937652',1,30,1,6,0,1400000,400000,1,0,'',0,'',1000000,6,3,166700,'13 ',' 20','2017-03-13 04:32:29',0,1);
...
insert  into `members_darurat`(`id_darurat`,`member_id`,`nama_darurat`,`hubungan`,`alamat`,`no_telp`) values (36,31,'Ayah Lintang',1,'Lintang Selatan','432564'),(39,32,'12',4,'12','12'),(40,33,'12',4,'12','12'),(44,30,'1',3,'1','1'),(46,27,'2',2,'2','2'),(47,34,'Muhajir',5,'hkdhfasihp','2173097'),(48,35,'HARGIANTO',5,'DSN. BANJARMLATI, DS BANJARAGUNG, KEC. BALONG PANGGANG-GRESIK','0812334334');
...
insert  into `purchases`(`purchases_id`,`user_id`,`purchases_date`,`purchases_code`,`supplier_id`,`branch_id`,`bank_id`,`bank_account`,`bank_id_to`,`bank_account_to`,`payment_method`,`purchase_total`,`purchase_payment`,`purchase_change`,`lunas`,`purchase_desc`) values (2,1,'2017-03-04 10:36:51',1488620225,1,3,0,0,0,0,1,1200000,1200000,0,0,''),(3,1,'2017-03-11 07:56:19',1489215384,5,3,0,0,0,0,1,120000000,120000000,0,0,''),(4,1,'2017-03-13 03:46:01',1489373165,1,3,0,0,0,0,1,1200000,1200000,0,0,''),(5,1,'2017-03-13 04:03:58',1489374251,7,3,0,0,0,0,1,2500000,2500000,0,0,'');
...
insert  into `purchases_details`(`purchase_detail_id`,`purchase_id`,`purchase_date`,`item_id`,`purchase_qty`,`purchase_price`,`purchase_total`,`retur`,`unit_id`) values (1,2,'2017-03-04',1,1,1200000,1200000,0,14),(2,3,'2017-03-11',39,1,120000000,120000000,0,0),(3,4,'2017-03-13',1,1,1200000,1200000,0,14),(4,5,'2017-03-13',41,1,2500000,2500000,0,0);
...
insert  into `transaction_details`(`transaction_detail_id`,`transaction_id`,`kategori`,`item_id`,`transaction_detail_original_price`,`transaction_detail_margin_price`,`transaction_detail_price`,`transaction_detail_persen_discount`,`transaction_detail_nominal_discount`,`transaction_detail_grand_price`,`transaction_detail_qty_real`,`transaction_detail_qty`,`transaction_detail_unit`,`transaction_detail_total`,`retur`) values (3,1,6,1,1400000,0,1400000,0,0,0,1,1,14,1400000,0),(4,2,6,1,1400000,0,1400000,0,0,0,1,1,14,1400000,0),(5,3,6,1,1400000,0,1400000,0,0,0,1,1,14,1400000,0),(6,4,6,1,1400000,0,1400000,0,0,0,1,1,14,1400000,0),(7,5,6,41,2800000,0,2800000,0,0,0,1,1,0,2800000,0),(8,6,6,1,1400000,0,1400000,0,0,0,1,1,14,1400000,0);
...
insert  into `transaction_details_item`(`transaction_details_item`,`transaction_id`,`transaction_detail_id`,`item_id`,`keterangan_item`) values (9,1,3,1,1),(10,2,4,1,0),(11,2,4,1,0),(12,2,4,1,4),(13,3,5,1,0),(14,3,5,1,0),(15,3,5,1,5);
...
insert  into `transactions`(`transaction_id`,`member_id`,`partner_id`,`transaction_date`,`transaction_total`,`transaction_discount`,`total_discount_persen`,`transaction_discount_nominal`,`transaction_grand_total`,`transaction_payment`,`transaction_change`,`payment_method_id`,`bank_id`,`i_bank_account`,`bank_id_to`,`i_bank_account_to`,`user_id`,`transaction_code`,`tax`,`total_all`,`transaction_desc`,`lunas`,`branch_id`) values (1,34,0,'2017-03-04 04:47:06',1400000,0,0,0,1400000,1400000,0,1,0,0,0,0,1,1488599226,0,1400000,'',0,3),(2,31,0,'2017-03-04 08:11:56',1400000,0,0,0,1400000,1400000,0,1,0,0,0,0,1,1488611516,0,1400000,'',0,3),(3,27,0,'2017-03-13 03:47:11',1400000,0,0,0,1400000,1400000,0,1,0,0,0,0,1,1489373231,0,1400000,'',0,3),(4,34,0,'2017-03-13 03:49:08',1400000,0,0,0,1400000,300000,0,5,0,0,0,0,1,1489373348,0,1400000,'',1,3),(5,35,0,'2017-03-13 04:19:22',2800000,0,0,0,2800000,700000,0,5,0,0,0,0,1,1489375162,0,2800000,'',1,3),(6,30,0,'2017-03-13 04:32:29',1400000,0,0,0,1400000,400000,0,5,0,0,0,0,1,1489375949,0,1400000,'',1,3);
...
insert  into `unit_konversi`(`unit_konversi_id`,`item_id`,`unit_id`,`unit_jml`,`unit_konversi`,`unit_konversi_jml`,`harga_konversi`) values (12,2,20,1,17,10000,1600000);
