...
switch ($page) {
  ...
  case 'play_video':
    ...
    $path = "../video/";
    $where_tutorial_id = "WHERE tutorial_id = '$id'";
    $i_video = select_config_by('tutorial', 'tutorial_video', $where_tutorial_id);
    $play_video = $path.$i_video;
    include '../views/tutorial/popmodal_video.php';
    break;
}
