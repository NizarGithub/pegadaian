...
function select_keterangan_details_retur($item_id, $kategori_keterangan_id, $purchase_id){
		$query = mysql_query("SELECT a.* FROM item_keterangan_details a
													WHERE a.item_id = '$item_id' and a.kategori_keterangan_id = '$kategori_keterangan_id'
													AND a.item_keterangan_details_id NOT IN (
																SELECT kategori_keterangan_id FROM wr_pembelian_details_tmp
