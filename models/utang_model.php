<?php
  function select(){
      $query = mysql_query("SELECT a.*, b.*, c.* FROM hutang a
                            ...
                            JOIN  suppliers c ON c.supplier_id = c.supplier_id GROUP by c.supplier_id");
      return $query;
  }
  ...
  function select_hutang($id){
      $query = mysql_query("SELECT a.*, b.*, d.supplier_name FROM hutang a
                            ...
                            WHERE a.id_hutang ='".$id."'");
    return $query;
  }

  function get_supplier_id($id){
    $query = mysql_query("SELECT a.supplier_id FROM hutang a WHERE a.id_hutang = '".$id."'");
