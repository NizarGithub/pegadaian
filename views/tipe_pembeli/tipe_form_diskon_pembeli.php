...
<div class="modal fade" tabindex="-1" role="dialog" id="item_popmodal" style="border-radius:0;">
  <div class="modal-dialog" role="document">
    <div class="modal-content" id="item_popmodal_content" style="border-radius:0;">
