                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="textarea" id="penghasilan_currency" name="penghasilan_currency" class="form-control number_only" value=""
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="textarea" id="pengeluaran_currency" name="pengeluaran_currency" class="form-control number_only" value=""
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="textarea" id="penghasilan_lain_currency" name="penghasilan_lain_currency" class="form-control number_only" value=""
                              placeholder="Masukkan Penghasilan..."  onkeyup="lookup(this);"/>
...
function btn_add_pembeli_cash(){
  var transaction_id = $('#transaction_id').val();
  $('#medium_modal').modal();
  var url = 'transaction_new.php?page=btn_add_pembeli_cash&id='+transaction_id;
    $('#medium_modal_content').load(url,function(result){
  });
  $('#tambah_pembeli_popmodal').modal('hide');
}
