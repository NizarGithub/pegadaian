												...
												data-live-search="true" value="0" onchange="tambah_pembeli()">
													...
													while ($r_member = mysql_fetch_array($q_member)) {
														...
														<option value="<?= $r_member['member_id']?>"
															...
															<?php if ($xx!=0){echo "data-icon='fa fa-lock' disabled";} ?>>
									...
									<div id="table_history"></div>
										...
										<div style="display:none;">
											<div class="row menu-bar">
												<div class="col-md-3 menu-bar-btn" id="btn_bar_1" onclick="get_change(1)"
												style="background-color: #d82827;">
										...
										<div id="all_menu_list">
											<div class="">
												<table id="menu_list_tb" class="table table-bordered" style="display:none;">
...
aria-labelledby="myLargeModalLabel" style="z-index:2;">
...
<div id="item_popmodal_details" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog"
aria-labelledby="myLargeModalLabel" style="z-index:4;">
 <div class="modal-dialog modal-lg" role="document" style="width:800px;">
	 <div class="modal-content" id="item_popmodal_details_content" style="border-radius:0px;">
...
function test() {
				...
				for (var i = 0; i < data.length; i++) {
					$('#menu_list_body_tb').append('\
						<tr id="tr_1_'+i+'">\
							...
							<td id="harga_v_'+i+'" align="center"><strong>'+data[i].item_price+'\
							</strong></td>\
	...
	function konversi_qty_list(i){
		var x = $('#select_unit_'+i).val();
		var y = $('#real_stock_qty_'+i).val();
		var z = $('#item_id_'+i).val();
		$.ajax({
				type:'POST',
				data:{x:x,y:y,z:z},
			...
			$('#harga_v_'+i).html('');
			$('#harga_v_'+i).html('<strong>'+data.harga_konversi+'</strong>');
		});
	}
			...
			for(var inn = 0; inn <= data.length; inn++){
				...
				<div class="col-md-3">\
					<div class="panel panel-default jcorgFilterTextParent">\
						<a id="dialogModal_ex_'+inn+'" onclick="dialogModal('+data[inn].item_id+')">\
						<input type="hidden" value="1"/>\
							<div class="panel-heading" style="text-align:center;color:#d82827;">\
								<div class="panel-title">'+data[inn].item_name+'</div>\
							</div>\
							<div class="panel-body">\
								<center>\
									<div class="form-group" style="max-width:150px;max-height:150px;">\
										<img id="output_1" class="img-responsive" src="../img/menu/'+data[inn].stock_img+'" style="height:140px;">\
									</div>\
								</center>\
							</div>\
							<div class="panel-footer" style="float:bottom-left;text-align:center;color:#d82827;">\
								<div class="">'+data[inn].item_price+'</div>\
								<div class="jcorgFilterTextChild">'+data[inn].item_name+'</div>\
							</div>\
						</a>\
					</div>\
				</div>\
						...
						<div class="col-md-3">\
							<div class="panel panel-default jcorgFilterTextParent">\
								...
								<input type="hidden" value="1"/>\
									...
									<div class="panel-footer" style="float:bottom-left;text-align:center;color:#d82827;">\
										<div class="">'+data.data[inn].item_price+'</div>\
			...
			$(this).on('keyup',function(){
				...
				$.ajax({
					...
					for (var i = 0; i < data.length; i++) {
						...
						<div class="col-md-3">\
							<div class="panel panel-default jcorgFilterTextParent">\
								<a id="dialogModal_ex_'+i+'" onclick="dialogModal('+data[i].item_id+')">\
								<input type="hidden" value="1"/>\
									<div class="panel-heading" style="text-align:center;color:#d82827;">\
										<div class="panel-title">'+data[i].item_name+'</div>\
									</div>\
									<div class="panel-body">\
										<center>\
											<div class="form-group" style="max-width:150px;max-height:150px;">\
												<img id="output_1" class="img-responsive" src="../img/menu/'+data[i].stock_img+'" style="height:140px;">\
											</div>\
										</center>\
									</div>\
									<div class="panel-footer" style="float:bottom-left;text-align:center;color:#d82827;">\
										<div class="">'+data[i].item_price+'</div>\
										<div class="jcorgFilterTextChild">'+data[i].item_name+'</div>\
									</div>\
								</a>\
							</div>\
						</div>\
